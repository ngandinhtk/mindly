...
export const emotions = [
    { id: 'happy', emoji: '😊', label: 'happy', color: 'bg-red-200 hover:bg-red-100', graphColor: '#f87fb1c7' },
    ...
    { id: 'neutral', emoji: '😌', label: 'neutral', color: 'bg-gray-200 hover:bg-gray-300', graphColor: '#d1d3cfe7' },
